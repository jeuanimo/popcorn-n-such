...
urlpatterns = [
    ...
    path("profile/avatar/upload/", avatar_upload_view, name="avatar-upload"),
    path("profile/avatar/delete/", avatar_delete_view, name="avatar-delete"),
    path("profile/bio/", bio_update_view, name="bio-update"),
    path("profile/posts/create/", post_create_view, name="post-create"),
    path("profile/posts/<int:post_id>/edit/", post_edit_view, name="post-edit"),
    path("profile/posts/<int:post_id>/delete/", post_delete_view, name="post-delete"),
    path("profile/posts/<int:post_id>/comments/create/", comment_create_view, name="comment-create"),
    path("profile/comments/<int:comment_id>/delete/", comment_delete_view, name="comment-delete"),
